...
const NoticesSection = () => {
  ...
  const notices = [
    ...
    },
    {
      ...
      title: 'Exam Dates Announced - October 26 & November 2, 2025',
      content: 'The Talent Search Exam will be conducted on October 26 & November 2, 2025, through online computer-based test. Duration: 60 minutes for 60 questions covering Physics, Chemistry, Biology & Mathematics.',
      date: '2025-01-18',
      time: '2:00 PM',
